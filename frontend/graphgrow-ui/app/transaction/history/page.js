    ...
    <div className="p-2.5">
      ...
      <div className="mt-2.5">
        ...
        {filteredList.map((list) => (
          <div
            key={list.s_no}
            className="grid grid-cols-[minmax(10px,_50px)_4fr_repeat(7,_1fr)] lg:overflow-visible md:overflow-visible sm:overflow-scroll auto-rows-max text-right gap-x-5 font-bold text-[0.8em] items-center border-b-1 border-gray-300 pt-2 pb-2"
          >
